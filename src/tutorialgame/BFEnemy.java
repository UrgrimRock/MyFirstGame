...
public class BFEnemy extends GameObject {
    private Handler handler;

    public BFEnemy(int x, int y, ID id, Handler handler){
        super(x, y, id);
    ...
    public void tick() {
        ...
        //handler.addObject(new Trail(x, y, ID.Trail, Color.ORANGE, 100, 50, 0.05f, handler));
        collision();
    }
